...
To earn the verified badge you submit a **selfie photograph** and a short **liveness video (3–15 seconds)**. These are processed by our verification provider **Persona** for face matching and liveness detection. Original artifacts are retained for **180 days** then automatically deleted.
